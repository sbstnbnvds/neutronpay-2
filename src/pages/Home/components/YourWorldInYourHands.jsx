...
import Google from '../../../assets/images/home/google-play-badge.png'
import Apple from '../../../assets/images/home/Download_on_the_App_Store_Badge_US-UK_RGB_blk_092917.svg'
      ...
      <Row className='w-100 m-0 justify-content-around align-items-center position-relative z-2'>
        <Col xs={4}>
          <Row className='w-100 align-items-center'>
            <Col xs={5} onClick={() => console.log('holi')}>
