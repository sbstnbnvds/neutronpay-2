    ...
    <section className="banner-company eerie-black-background py-5 position-relative w-100">
      <Row className='w-100 justify-content-center py-5'>
        <Col xs={8}>
          ...
          <p className='steel-pink-text text-center fs-4 fw-semibold px-5 mx-4 mb-5 pb-5'>by enabling open global finance without borders using the Lightning Network</p>
        </Col>
