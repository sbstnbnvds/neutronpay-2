...
const AppCarousel = () => {
  return (
    <section className='mb-5'>
      ...
      {/* Mobile Version */}
      <Container className='d-lg-none px-sm-0'>
        <div className='neutronpay-send-cash border border-4 border-black rounded-4 px-0 overflow-hidden mb-4'>
          <Row className='mx-0 py-5 py-md-0 justify-content-end position-relative h-100'>
            <Col className='d-lg-none'>
              <div className="ps-3 h-100 d-flex flex-column">
                <h3 className='text-capitalize display-3 pe-5 mt-md-5 mb-5 mb-md-4 mb-xl-5 mb-xxl-4 pt-md-5 fw-semibold'>Neutronpay's <br />send cash</h3>
                <Col
                  xs={12}
                  lg={10}
                  as='ul'
                  className='fs-3 ps-0 d-flex flex-column justify-content-around flex-grow-1 mb-md-5'
                >
            ...
            <Col className='position-absolute translate-middle-y top-50 start-0 ps-2 ps-xl-5 d-none d-lg-block' xs={7} lg={8} xl={8} xxl={10}>
              <div className="ps-3 ps-xxl-5">
                ...
                >
                  {thirdSlideContent.map((listItem, key) => <li className='mb-3 mb-lg-4 mb-xl-5 d-flex align-items-center' key={key}>
                    <Col as='img' xs={2} lg={3} xl={2} xxl={1} src={listItem.icon} alt='' className=' me-lg-0 me-xl-1  me-xxl-3 px-0 px-sm-2 px-lg-3 px-xl-4 px-xxl-0' />
            ...
            <Col as='img' src={sendCashImage} xs={'auto'} className='p-0 d-none d-lg-block h-100'></Col>
          </Row>
        </div>
        <div className='eerie-black-background p-4 text-white start-simplifying d-flex flex-column border border-4 border-black rounded-4 px-0 overflow-hidden mb-4'>
          ...
          <div className="px-4 px-sm-0 px-xl-5 flex-grow-1 d-flex flex-column justify-content-around">
              ...
              <Col
                ...
                <Row className='mx-0'>
                  <Col xxl={11} xl={10} lg={11} md={11} sm={10}>
                    ...
                    <p className=' pe-xl-0'>Easily send and receive international payments, expanding your reach.</p>
                  </Col>
              ...
              <Col
                ...
                <Row className='mx-0'>
                  <Col xl={11} lg={11} md={10} sm={11}>
                    ...
                    <p className='lh-sm'>Neutronpay's PoS feature lets small businesses accept Bitcoin payments on various devices, converting them instantly to local currency.</p>
                  </Col>
              ...
              <Col
                ...
                <Row className='mx-0'>
                  <Col xl={12} md={11}>
                    ...
                    <p className='lh-sm pe-lg-4'>Use LNURL for hassle-free payments. Connect with your global audience and receive payments effortlessly. Our platform eliminates all the complexity of traditional methods.</p>
                  </Col>
                </Row>
                ...
                <Row className='mx-0 justify-content-end'>
                  <Col xl={12}>
                    <Row className='mx-0 p-0 justify-content-end'>
                      ...
                      <p className='lh-sm ps-xl-5 ps-lg-5 ps-md-5 ps-sm-4 ps-0'>Get paid instantly with minimal fees, anywhere in the world. Neutronpay ensures your hard work is rewarded without delay or high transaction costs.</p>
        ...
        <div className='LNURL-advance text-white pt-5 pb-4 border border-4 border-black rounded-4 px-0 overflow-hidden mb-4'>
      ...
      {/* Desktop Version */}
      <Container className='d-none d-lg-block border border-4 border-black rounded-4 px-0 overflow-hidden'>
        <Carousel className='' indicators={false} interval={null} prevIcon={prevButton} nextIcon={nextButton}>
          <Carousel.Item className='neutronpay-send-cash'>
            <Row className='mx-0 py-5 py-md-0 justify-content-end position-relative h-100'>
              ...
              <Col className='position-absolute translate-middle-y top-50 start-0 ps-2 ps-xl-5 d-none d-md-block' xs={7} lg={8} xl={8} xxl={9}>
                <div className="ps-3 ps-xxl-5">
                  <h3 className='text-capitalize display-3 pe-5 mb-4 mb-xl-5 mb-xxl-4 fw-semibold'>Neutronpay's <br />send cash</h3>
                  <Col
                    xs={12}
              ...
              <Col as='img' src={sendCashImage} xs={'auto'} className='p-0 d-none d-md-block'></Col>
            </Row>
          </Carousel.Item>
...
{/* 
      <Container className='border border-4 border-black rounded-4 px-0 overflow-hidden d-none d-lg-block'>
        <Carousel className='' indicators={false} interval={null} prevIcon={prevButton} nextIcon={nextButton}>
          <Carousel.Item className='neutronpay-send-cash'>
            <Row className='mx-0 py-5 py-md-0 justify-content-end position-relative h-100'>
              <Col className='d-lg-none'>
              ...
              <Col as='img' src={sendCashImage} xs={'auto'} className='p-0 d-none d-lg-block'></Col>
            </Row>
          </Carousel.Item>
          <Carousel.Item className='eerie-black-background p-4 text-white start-simplifying d-flex flex-column'>
            <h3 className='steel-pink-text text-center display-4 fw-semibold text-capitalize mb-3'>start simplifying</h3>
            <p className='text-center fs-5 mb-4 mb-sm-3 mb-xl-4'>Neutronpay is more than a payment platform; it's a gateway to a world where payments are no longer boring. Start simplifying your life with Neutronpay today.</p>
            <div className="px-4 px-sm-0 px-xl-5 flex-grow-1 d-flex flex-column justify-content-around">
              <Row className='justify-content-between mx-0 mb-3 mb-xl-3 gy-3'>
