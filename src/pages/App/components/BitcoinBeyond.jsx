  ...
  return (
    <section className="bitcoin-beyond-section">
      <Container>
        ...
        <h2 className='steel-pink-text text-capitalize text-center py-0 my-1 display-2 fw-semibold pb-4'>Bitcoin beyond assets <br className='d-none d-md-inline'/> a world of value</h2>
